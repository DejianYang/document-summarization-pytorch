...
parser.add_argument('--train_path', action='store', dest='train_path',
                    default='./data/toy_reverse/train/data.txt', help='Path to train data')
parser.add_argument('--dev_path', action='store', dest='dev_path',
                    default='./data/toy_reverse/dev/data.txt', help='Path to dev data')
parser.add_argument('--expt_dir', action='store', dest='expt_dir', default='./data/toy',
...
src.build_vocab(train, max_size=5000)
tgt.build_vocab(train, max_size=5000)
